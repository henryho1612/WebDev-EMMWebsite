<%@ Page Title="" Language="C#" MasterPageFile="~/ERM.Master" AutoEventWireup="true" CodeBehind="viewPrescription.aspx.cs" Inherits="COSC2450_A2_s3357671.viewPrescription" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <h2 id="PrescriptionDetailTitle" class="bodyTitle">A Prescription Detail</h2>
    <%--Display Prescription Detail--%>
    ...
    <div id="displayPanel">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <asp:FormView ID="FormView1" runat="server" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" DataKeyNames="prescriptionId" DataSourceID="LinqDataSource1" GridLines="Horizontal" OnItemDeleted="FormView1_ItemDeleted" OnItemDeleting="FormView1_ItemDeleting" OnItemUpdated="FormView1_ItemUpdated" OnPreRender="FormView1_PreRender">
                    <EditItemTemplate>
                        ID:
                        <asp:Label ID="EditId" runat="server" Text='<%# Eval("prescriptionId") %>' />
                        <br />
                        Doctor Name:
                    ...
                    <ItemTemplate>
                        ID:
                        <asp:Label ID="ViewId" runat="server" Text='<%# Eval("prescriptionId") %>' />
                        <br />
                        Doctor Name:
                        <asp:Label ID="ViewDName" runat="server" Text='<%# Bind("Doctor.doctorName") %>' />
                        <br />
                        Written Date:
                        <asp:Label ID="ViewDate" runat="server" Text='<%# Bind("dateWritten") %>' />
                        <br />
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="COSC2450_A2_s3357671.DBDataContext" EnableDelete="True" EnableInsert="True" EnableUpdate="True" EntityTypeName="" TableName="Prescriptions" Where="prescriptionId == @prescriptionId">
                    <WhereParameters>
                        <asp:QueryStringParameter Name="prescriptionId" QueryStringField="ID" Type="Int64" />
                    </WhereParameters>
                </asp:LinqDataSource>
            </ContentTemplate>
        </asp:UpdatePanel>
